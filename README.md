...
### Eclipse
#### Prerequisites
1. Install [Eclipse IDE 2021-06](https://www.eclipse.org/downloads/packages/release/2021-06/r/eclipse-ide-java-developers)
...
1. Generates all Eclipse configuration files: 
    ...
    ./gradlew eclipse
    ```
1. [Import the project to Eclipse](https://help.eclipse.org/2021-06/index.jsp?topic=%2Forg.eclipse.platform.doc.user%2Ftasks%2Ftasks-importproject.htm)
